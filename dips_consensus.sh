## Generating Consensus Sequence for diploids from VCFs ##

#!/bin/bash
#SBATCH --job-name=Cdips
...
#SBATCH --mem=30g
#SBATCH --output=/shared/Project2_Resources/Group2/OnE/%CD.out
#SBATCH --error=/shared/Project2_Resources/Group2/OnE/%CD.err
