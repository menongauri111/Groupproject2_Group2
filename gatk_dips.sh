## Generating VCFs for the diploid population containing only biallelic SNPs at AF > 50% (majority) in the exons ##

#!/bin/bash
#SBATCH --job-name=Gdips
...
#SBATCH --mem=30g
#SBATCH --output=/shared/Project2_Resources/Group2/OnE/%Gdips.out
#SBATCH --error=/shared/Project2_Resources/Group2/OnE/%Gdips.err
...
gatk SelectVariants \
        ...
        -V /shared/Project2_Resources/Group2/VCFs/For_Students_2023/UK_scan_dips.vcf \
        -L Cexcelsa_scaf_2:19237478-19237720 \
        -L Cexcelsa_scaf_2:19237869-19237910 \
        --restrict-alleles-to BIALLELIC \
        -select "AF>0.5" \
        -O /shared/Project2_Resources/Group2/VCFs/For_Students_2023/diploids/Finalg42720_dips.vcf
...
gatk SelectVariants \
        ...
        --restrict-alleles-to BIALLELIC \
        -select "AF>0.5" \
        -O /shared/Project2_Resources/Group2/VCFs/For_Students_2023/diploids/Finalg40349_dips.vcf
...
gatk SelectVariants \
        ...
        --restrict-alleles-to BIALLELIC \
        -select "AF>0.5" \
        -O /shared/Project2_Resources/Group2/VCFs/For_Students_2023/diploids/Finalg38026_dips.vcf
...
gatk SelectVariants \
        ...
        --restrict-alleles-to BIALLELIC \
        -select "AF>0.5" \
        -O /shared/Project2_Resources/Group2/VCFs/For_Students_2023/diploids/Finalg30996_dips.vcf